...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        # Carregando peso e vieses do moddelo
        self.load_state_dict(torch.load('./modelo_treinado.pth', map_location=device))
        self.eval()
    ...
    def classificar_imagem(self, imagem):
        ...
        return self.classes[predicao], probabilidade